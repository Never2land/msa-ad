...
declared anchor channel, and a predeclared seeded known-fault campaign of
100 positive controls (fault catalogue and acceptance logic are declared in
the executing code and recorded in the released audit trail; the campaign
was not independently preregistered). Every input, output, hash and parameter is recorded in
